...
function getMonths(type,month){
    ...
    var monthsEng=["T1","T2","T3","T4","T5","T6","T7","T8","T9","T10","T11","T12"];
    var i=1;
    switch (type) {
        case 0:
            for(i=month;i<=12;i++)
    ...
    switch(type){
        ...
        case 3:
            if(hour>=23||hour<1){
                ...
                shichen.index=5;
                shichen.str="9PM -> 11AM"
            }
            else if(hour>=11&&hour<13){
                shichen.index=6;
                shichen.str="11AM -> 13PM"
            }
            else if(hour>=13&&hour<15){
                shichen.index=7;
                shichen.str="13PM -> 15PM"
            }
            else if(hour>=15&&hour<17){
                shichen.index=8;
                shichen.str="15PM -> 17PM"
            }
            else if(hour>=17&&hour<19){
                shichen.index=9;
                shichen.str="17PM -> 19PM"
            }
            else if(hour>=19&&hour<21){
                shichen.index=10; 
                shichen.str="19PM -> 21PM"
            }
            else if(hour>=21&&hour<23){
                shichen.index=11;
                shichen.str="21PM -> 23PM"
            }
            break;
    }
...
function getShiChens(type,shichen){
    ...
    var shichen3=["23PM -> 1AM","1AM -> 3AM","3AM -> 5AM","5PM -> 7AM","7PM -> 9AM","9PM -> 11AM","11AM -> 13PM","13PM -> 15PM","15PM -> 17PM","17PM -> 19PM","19PM -> 21PM","21PM -> 23PM"];
    switch(type){
        case 0:
...
function getWeeks(type,week){
    weeks=[];
    weeksEng=["T.CN","T.Hai","T.Ba","T.Tư","T.Năm","T.Sáu","T.Bảy"];
    var i=0;
    switch(type){
        case 0:
        case 1:
...
function getWeek(type,week){
    weekEng=["T.CN","T.Hai","T.Ba","T.Tư","T.Năm","T.Sáu","T.Bảy"];
    res="";
    switch(type){
        case 0:
        case 1:
